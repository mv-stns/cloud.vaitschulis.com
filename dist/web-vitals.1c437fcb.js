      ...
      function (require, module, exports) {
        ...
        var e1,
          ...
          o1 = function (e, t) {
            ...
            addEventListener("visibilitychange", n2, !0),
              addEventListener("pagehide", n2, !0);
          },
          c = function (e) {
            addEventListener(
              "pageshow",
          ...
          u1 = "function" == typeof WeakSet ? new WeakSet() : new Set(),
          f = function (e, t, n) {
            var i;
            return function () {
              t.value >= 0 &&
                (n || u1.has(t) || "hidden" === document.visibilityState) &&
                ((t.delta = t.value - (i || 0)),
          ...
          E = function (e5) {
            if (e5.cancelable) {
              var t2 =
                (e5.timeStamp > 1000000000000
                  ? new Date()
                  : performance.now()) - e5.timeStamp;
              "pointerdown" == e5.type
                ? (function (e, t) {
                    var n = function () {
                        y(e, t), a();
                      ...
                      a = function () {
                        removeEventListener("pointerup", n, h1),
                          removeEventListener("pointercancel", i, h1);
                      };
                    addEventListener("pointerup", n, h1),
                      addEventListener("pointercancel", i, h1);
                  })(t2, e5)
                : y(t2, e5);
            }
          },
          ...
          T = function (e6, t3) {
            ...
            if (p) {
              ...
              var v = function () {
                u1.has(s) ||
                  (p.takeRecords().map(m), p.disconnect(), u1.add(s), n());
              };
          ...
          b = function (e7) {
            ...
            (t4 = function () {
              try {
                ...
                if (((n3.value = n3.delta = t5.responseStart), n3.value < 0))
                  return;
                (n3.entries = [t5]), e7(n3);
              } catch (e) {}
            }),
