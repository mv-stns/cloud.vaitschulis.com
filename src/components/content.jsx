      ...
      <main className="bg-white dark:bg-zinc-700">
        ...
        <div className="bg-zinc-50 dark:bg-zinc-700">
          <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <p className="text-sm font-semibold tracking-wide text-center uppercase text-zinc-500">
              Bereits für folgende Unternehmen gearbeitet
            </p>
            <div className="grid grid-cols-2 gap-8 mt-16 md:grid-cols-6 lg:grid-cols-5">
              <div className="flex justify-center col-span-1 md:col-span-2 lg:col-span-1">
                <svg
                  className="h-12 duration-200 fill-current text-zinc-400 hover:text-deepred hover:drop-shadow-2xl"
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
                  height="100%"
                  viewBox="0 0 2560 269"
                  version="1.1"
                >
              ...
              <div className="relative flex justify-center col-span-1 md:col-span-2 md:col-start-2 lg:col-span-1 filter">
                <svg
                  className="h-12 fill-current text-zinc-400 hover:text-zinc-300"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <div className="relative flex justify-center col-span-2 md:col-span-2 md:col-start-4 lg:col-span-1 filter">
                <svg
                  className="h-12 fill-current text-zinc-400 hover:text-amber-300"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  ...
                  <defs>
                    ...
                    >
                      <rect
                        ...
                        width="4"
                        height="4"
                        className="text-zinc-200 dark:text-zinc-500"
                        fill="currentColor"
                      />
                    </pattern>
                  </defs>
                ...
                <div className="relative max-w-md px-4 mx-auto my-auto sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                  <div className="relative pt-12 pb-10 overflow-hidden shadow-2xl md:pt-64 rounded-2xl">
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1515890922410-ae767899d6b3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Y2xvdWR8ZW58MHx8MHx8&auto=format&fit=crop&w=1100&q=60"
                      alt=""
                    />
                    ...
                    <div className="relative px-8">
                      <div>
                        <span
                          className="text-6xl font-extrabold text-white font-sharp-sans"
                      ...
                      <blockquote className="mt-8">
                        <div className="relative text-lg font-medium text-white md:flex-grow">
                          <svg
                            className="absolute top-0 left-0 w-8 h-8 transform -translate-x-3 -translate-y-2 text-amber-400"
                            fill="currentColor"
                            viewBox="0 0 32 32"
                            aria-hidden="true"
                          >
                          ...
                          <p className="relative pt-4">
                            Diese Seite ist ein Miniprojekt meinerseits, um
                            sowohl meine Coding Fähigkeiten unter Beweis zu
                            stellen, aber auch, um meine Projekte in diesem
                            Portfolio präsentieren zu können.
                          </p>
                        </div>
                        <footer className="mt-4">
                          <p className="text-base font-semibold text-amber-200">
                            Marcus Vaitschulis, CEO bei v.Cloud
                          </p>
                        </footer>
                      </blockquote>
                    </div>
              ...
              <div className="pt-12 sm:pt-16 lg:pt-20">
                <div className="relative">
                  ...
                  <div className="relative flex justify-start">
                    <h2 className="pr-4 text-3xl font-bold tracking-tight bg-white dark:text-zinc-300 text-zinc-700 dark:bg-zinc-700 sm:text-4xl">
                      Über mich
                    </h2>
                  </div>
                </div>
                <div className="mt-6 space-y-6 text-xs leading-7 md:text-base text-zinc-500 dark:text-zinc-300">
                  <p>
                    Ich bin ein ambitionierter junger Mann, der sich bereits
                    seit 2015 im Bereich Mediengestaltung / Mediendesign Fuß
                    fasst. In der schulischen Ausbildung am{" "}
                    <a
                      href="https://adolph-kolping-berufskolleg.eu"
                      target="_blank"
                      className="font-medium underline transition-all duration-150 ease-in-out decoration-orange-500 hover:decoration-orange-300 underline-offset-[5px] decoration-wavy decoration-2"
                      rel="noreferrer"
                    >
                      Adolph-Kolping-Berufskolleg in Münster
                    </a>
                    &nbsp;als Gestaltungstechnischen Assistenten wurde mir ein
                    breit gefächertes Themengebiet auf dem Silbertablett
                    serviert, in denen ich mich erstmal zurechtfinden musste. In
                    dieser Zeit konnte ich während meiner Schulzeit und
                    natürlich auch privat in die Bereiche 3D-Animation, Film &
                    Schnitt, Bildbearbeitung, HTML & CSS und vieles mehr
                    hineinarbeiten. An meisten interessierte ich mich jedoch für
                    die Coding-Projekte.
                  </p>
                  <p>
                    Nach meinem erfolgreichen Abschluss an der Schule habe ich
                    eine Ausbildung als Mediengestalter im Fachbereich
                    Gestaltung & Technik begonnen. Dort konnte ich mithilfe von
                    WordPress einen sehr komplexen E-Commerce-Shop für das
                    Unternehmen entwickeln. Zusätzlich noch eine kleinere
                    multilinguale Homepage des Tochterunternehmens. Diese beiden
                    Webseiten haben mehrere Monate benötigt, um vollständig
                    entwickelt zu werden, da von Grund auf neue Freisteller
                    fotografiert und bearbeitet und diverse Servertechnologien
                    selbst erlernt werden mussten. Da sind mir die Erfahrungen
                    der vorherigen Lehre sehr gelegen gekommen.
                  </p>
                  <p>
                    Mittlerweile bin ich in der Lage dazu, mich mithilfe dieser
                    erlangten Fähigkeiten meine eigenen komplexen Projekte
                    entwickeln.
                  </p>
                </div>
              </div>
          ...
          <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="px-6 py-10 bg-gradient-to-bl from-red-500 via-indigo-500 to-blue-500 rounded-3xl sm:py-16 sm:px-12 lg:p-20 lg:flex lg:items-center">
              <div className="lg:w-0 lg:flex-1">
                ...
                <p className="max-w-3xl mt-4 text-lg text-zinc-100">
                  Ab und an versende ich wohl möglich paar hilfreiche Tipps für
                  Mediengestalter oder UI/UX Designer ✌🏻.
                </p>
              </div>
              <div className="mt-12 sm:w-full sm:max-w-md lg:mt-0 lg:ml-8 lg:flex-1">
                <form className="sm:flex">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full px-5 py-3 border-white rounded-md placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-700 focus:ring-white disabled:opacity-30"
                    placeholder="E-Mail Adresse eingeben"
                    disabled
                  />
                  <button
                    type="submit"
                    className="flex items-center justify-center w-full px-5 py-3 mt-3 text-base font-medium text-white border border-transparent rounded-md pointer-events-none bg-zinc-500 hover:bg-zinc-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0 disabled:opacity-30"
                    disabled
                  >
                    Abonnieren
                  </button>
