...
import vCloudDark from "../assets/vcloud-dark.svg";
          ...
          <div className="z-30 flex flex-col items-center w-full max-w-xl text-center lg:items-start lg:w-1/2 lg:pt-24 lg:text-left">
            <div className="flex">
              <h1 className="relative mt-20 mb-4 text-3xl font-semibold leading-tight text-zinc-900 dark:text-white lg:pr-16 sm:text-6xl lg:mb-8">
                Willkommen <br />
                auf meinem{" "}
                <span className="font-black text-transparent dark:text-white text-7xl bg-gradient-to-r from-indigo-600 to-pink-600 bg-clip-text drop-shadow-sm">
                  Portfolio
                </span>
              </h1>
            </div>
            <div className="relative">
              <span className="rounded-md mt-2 mb-10 bg-blue-50 flex shrink-0 px-2.5 py-1 text-xs font-black text-blue-500 tracking-wide uppercase">
                {VERSION_TXT}&nbsp;{VERSION_NUMBER}
              </span>
            </div>
            <a
              href="#_"
              className="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 mb-16 text-base font-bold text-white bg-blue-700 border-t border-blue-600 rounded shadow-lg sm:mt-1 fold-bold lg:mx-0 shadow-blue-700/50"
            >
              Los geht's!
            </a>
          </div>
          <div
            className="z-50 flex-col items-end justify-center hidden w-full h-full lg:relative lg:flex shrink-0"
            style={{
              transform:
                "perspective(1200px) rotateX(15deg) rotateY(-23deg) scale3d(1, 1, 1)",
                            ...
                            <div className="py-2.5 grid items-center px-4 gap-8 grid-cols-[2.425rem,_1fr,_2.425rem] sm:grid-cols-[8rem,_1fr,_8rem]">
                              <div className="flex items-center">
                                ...
                                <svg
                                  ...
                                  height="24"
                                  fill="none"
                                  className="flex-none hidden ml-4 sm:block text-zinc-400 dark:text-zinc-700"
                                >
                                  <path
                                    d="m15 7-5 5 5 5"
                                    stroke="currentColor"
                              ...
                              <div>
                                <div className="flex items-center justify-center w-11/12 py-1 mx-auto text-xs font-medium leading-6 rounded-md sm:w-4/5 bg-zinc-100 dark:bg-zinc-700 text-zinc-400 dark:text-zinc-200 dark:text-zinc-700 ring-1 ring-inset ring-zinc-900/5 dark:ring-zinc-200/5">
                                  <svg
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    className="text-zinc-300 dark:text-zinc-500 w-3.5 h-3.5 mr-1.5"
                                  >
                                    <path
                                      fill-rule="evenodd"
                              ...
                              >
                                <div className="bg-zinc-100 dark:bg-[#303030] group dark:hover:from-zinc-700 dark:hover:to-zinc-700 hover:bg-gradient-to-b hover:from-zinc-100 text-zinc-400 dark:text-zinc-500 rounded-tl border border-zinc-900/5 pl-4 pr-8 py-1.5 -mb-px -mr-4 flex items-center justify-center space-x-2">
                                  <svg
                                    ...
                                    height="10"
                                    fill="currentColor"
                                    className="flex-none text-zinc-300 dark:text-zinc-500 group-hover:text-sky-400"
                                  >
                                    <path
                                      fill-rule="evenodd"
                                      clip-rule="evenodd"
                                  ...
                                  <div className="truncate">
                                    Tailwind UI - Official Tailwind CSS
                                    Components
                                  </div>
                                </div>
                              </a>
                              <a href="https://headlessui.dev" target="_blank">
                                <div className="bg-zinc-100 dark:bg-[#303030] dark:hover:from-zinc-700 group dark:hover:to-zinc-700 hover:bg-gradient-to-b hover:from-zinc-100 text-zinc-400 dark:text-zinc-500 rounded-tl border border-zinc-900/5 pl-4 pr-8 py-1.5 -mb-px -mr-4 flex items-center justify-center space-x-2">
                                  <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    className="flex-none text-zinc-300 dark:text-zinc-500 group-hover:text-cyan-400/80"
                                  >
                                  ...
                                  <div className="truncate">
                                    Headless UI – Unstyled, fully accessible UI
                                    components
                                  </div>
                                </div>
                              </a>
